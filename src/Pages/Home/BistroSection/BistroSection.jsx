...
const BistroSection = () => {
    return (
        <div className="bg-cover bg-no-repeat h-[70vh] relative my-16 rounded-lg object-cover" style={{ backgroundImage: `url(${service})` }}>
            <div className="bg-base-100 shadow-lg p-5 lg:p-10 space-y-5 rounded-lg text-center  absolute top-[20%] w-[70%] left-[15%] bg-opacity-70">
